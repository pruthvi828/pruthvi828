...
> **Last Synchronized:** `2026-09-25 11:56 UTC` via automated GitHub Actions daily dispatch.
...
| :--- | :--- | :--- | :---: | :---: |
| **Scottcjn/rustchain-bounties** | [ONBOARD: 3 RTC] Test the Miner and Post Your Hardware Report | `good first issue` `bounty` | 99 | [View Issue ↗](https://github.com/Scottcjn/rustchain-bounties/issues/2784) |
| **Scottcjn/rustchain-bounties** | Write a Review of RustChain — 3 RTC (Good First Issue) | `good first issue` `bounty` | 115 | [View Issue ↗](https://github.com/Scottcjn/rustchain-bounties/issues/443) |
...
| **Scottcjn/Rustchain** | [BOUNTY] Share Why You Starred RustChain — 3 RTC + Community Shoutout (Pool: 300 RTC) | `help wanted` `good first issue` | 184 | [View Issue ↗](https://github.com/Scottcjn/Rustchain/issues/165) |
...
| **Cytnx-dev/Cytnx** | Cannot +-*/ for diagonal and non-diagonal UniTensor | `bug` `good first issue` | 0 | [View Issue ↗](https://github.com/Cytnx-dev/Cytnx/issues/300) |
| **mortbopet/Ripes** | Improve UI colors by using system-provided palette | `enhancement` `good first issue` | 2 | [View Issue ↗](https://github.com/mortbopet/Ripes/issues/300) |
